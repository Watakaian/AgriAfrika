    ...
    Column(
        ...
        Column (
            ...
            Row (
                ...
                Button(
                    onClick = { navController.navigate(VIEW_CROP) },
            ...
            var cropPlanted by remember { mutableStateOf("") }
            var farmPlanted by remember { mutableStateOf("") }
            var cropQuantity by remember { mutableStateOf("") }
            var cropHandler by remember { mutableStateOf("") }
            val context = LocalContext.current

            OutlinedTextField(
                value = cropPlanted,
                onValueChange = { cropPlanted = it },
                placeholder = { Text(text="eg.Maize") },
                modifier = Modifier
                    .fillMaxWidth()
            ...
            OutlinedTextField(
                ...
                placeholder = { Text(text="eg. 1,000 seeds planted") },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = 15.dp),
                leadingIcon = {
...
@Composable
fun ImagePicker(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, numbers:String, location:String, handler:String) {
