...
fun UpdateTaskScreen(navController: NavHostController) {
    Column(
        ...
        Column (
            ...
            TaskUpdateButton(modifier,context, navController , taskName.trim() , taskDescription.trim() )
...
@Composable
fun TaskUpdateButton(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, description:String){
    Button(onClick = {
